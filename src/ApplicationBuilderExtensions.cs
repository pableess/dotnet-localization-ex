...
namespace Owin
{
    ...
    public static class ApplicationBuilderExtensions
    {
        ...
        public static IAppBuilder UseRequestLocalization(this IAppBuilder app)
        {
            if (app == null)
            {
            ...
            return app.Use<RequestLocalizationMiddleware>();
        }
        ...
        /// <returns>The <see cref="IAppBuilder"/>.</returns>
        public static IAppBuilder UseRequestLocalization(
            ...
            RequestLocalizationOptions options)
        {
            ...
            return app.Use<RequestLocalizationMiddleware>(options);
        }
